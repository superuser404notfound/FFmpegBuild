...
// Package.swift
dependencies: [
    .package(url: "https://github.com/superuser404notfound/FFmpegBuild", from: "3.5.0")
]
...
`build.sh` applies six small patches to the FFmpeg source after checkout (each documented in place):
